...
<head>
    ...
    <title>Welcome To <?php echo $_SESSION['email'] ?></title>
    ...
    <header class="body-font bg-black text-white">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                ...
                <span class="ml-3 text-xl text-white"><?php echo $_SESSION['email'] ?></span>
            </a>
...
<script defer>
    const createFile = ()=>{
        ...
        $.post('create_file_folder.php', {type: 'file', location: location}, (data, status)=>{
    ...
    const createFolder = ()=>{
        ...
        let location = `<?php echo escapeJsonString($location) ?>\\${filename}`;
        $.post('create_file_folder.php', {type: 'folder', location: location}, (data, status)=>{
            window.location.reload();
        })
    }
</script>
